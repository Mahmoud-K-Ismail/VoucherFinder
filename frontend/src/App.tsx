  ...
  return (
    <div className="min-h-screen py-8 px-4">
      ...
      <header className="text-center mb-12">
        ...
        <a
          href="https://drive.google.com/file/d/1A_hZxHwSw3mes_QUcww-Y50DItvshZS2/view"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-6 py-2 bg-white border-2 border-primary-500 text-primary-600 font-semibold rounded-lg hover:bg-primary-50 transition-all duration-200"
        >
